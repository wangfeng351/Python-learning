...
def calendar_draw() -> Calendar:
    ...
    calendar = (Calendar(init_opts=opts.InitOpts(width="1200px"))
                ...
                visualmap_opts=opts.VisualMapOpts(max_=25000, min_=2000,
                orient="horizontal", is_piecewise=True, pos_top="230px0", pos_left="100px",),
                )
                )
    return calendar

calendar_draw().render('./语法基础/html/步数统计.html')