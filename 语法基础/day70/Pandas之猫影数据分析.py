...
plt.rcParams['font.sans-serif'] = ['Droid Sans Fallback']  # Ubuntu做法
...
plt.savefig('./语法基础/res/image/mapyan1.png')
plt.show()
...
ax.legend(loc=1)
ax2.legend(loc=2)
plt.savefig('./语法基础/res/image/maoyan2.png')
plt.show()
...
plt.savefig('./语法基础/res/image/maoyan3.png')
plt.show()